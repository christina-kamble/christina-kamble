...
| ML & Deep Learning | PyTorch · TensorFlow · Scikit-learn · XGBoost · SHAP |
| BI & Visualisation | Power BI · Tableau · Streamlit · Plotly |
| Data Engineering | Pandas · NumPy · DuckDB · Excel |
| Cloud & Dev Tools | AWS · Git · GitHub · Jupyter · Google Colab |
| In Progress | Google Vertex AI · Azure ML |
---
## 📌 Featured Projects
